...
function SimpleVenueList({ venues = [] }) {
  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto mb-5">
      <div className="pt-5 mx-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-y-4 place-items-center">
        {visibleVenues.map((venue) => (
          <div key={venue.id} className="w-[140px] justify-center flex">
